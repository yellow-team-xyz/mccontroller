                    ...
                    if (get_official_addon == 'true') {
                        ...
                        if (fs.existsSync(`./addons/yellow-team-official.js`)) {
                            fs.writeFile(`./addons/yellow-team-official.js`, '//Disable', 'utf-8', function (err, data) {
                                lib.console_log('Yellow-Team-Official Addon Disable!', 3, 3);
                                deb_1();
                            });
                        } else {
                            deb_1();
    ...
    function deb_1() {
        if (fs.existsSync(`./package.json`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./package.json`, await download('http://dll.yellow-team.ir/dll/mccontroler/package.json'));
    ...
    function deb_2() {
        if (fs.existsSync(`./package-lock.json`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./package-lock.json`, await download('http://dll.yellow-team.ir/dll/mccontroler/package-lock.json'));
    ...
    function deb_3() {
        if (fs.existsSync(`./index.js`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./index.js`, await download('http://dll.yellow-team.ir/dll/mccontroler/index.js'));
    ...
    function deb_4() {
        if (fs.existsSync(`./config.yco`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./config.yco`, await download('http://dll.yellow-team.ir/dll/mccontroler/config.yco'));
    ...
    function deb_5() {
        if (fs.existsSync(`./server/software/feathermc/downloads.txt`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./server/software/feathermc/downloads.txt`, await download('http://dll.yellow-team.ir/dll/mccontroler/server/software/feathermc/downloads.txt'));
    ...
    function deb_6() {
        if (fs.existsSync(`./server/software/paper/downloads.txt`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./server/software/paper/downloads.txt`, await download('http://dll.yellow-team.ir/dll/mccontroler/server/software/paper/downloads.txt'));
    ...
    function deb_7() {
        if (fs.existsSync(`./server/software/spigot/downloads.txt`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./server/software/spigot/downloads.txt`, await download('http://dll.yellow-team.ir/dll/mccontroler/server/software/spigot/downloads.txt'));
    ...
    function deb_8() {
        if (fs.existsSync(`./server/server.properties`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./server/server.properties`, await download('http://dll.yellow-team.ir/dll/mccontroler/server/server.properties'));
    ...
    function deb_9() {
        if (fs.existsSync(`./server/eula.txt`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./server/eula.txt`, await download('http://dll.yellow-team.ir/dll/mccontroler/server/eula.txt'));
    ...
    function deb_10() {
        if (fs.existsSync(`./server/server-icon.png`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./server/server-icon.png`, await download('http://dll.yellow-team.ir/dll/mccontroler/server/server-icon.png'));
    ...
    function deb_11() {
        if (fs.existsSync(`./data/blacklist_ip.ydb`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./data/blacklist_ip.ydb`, await download('http://dll.yellow-team.ir/dll/mccontroler/data/blacklist_ip.ydb'));
    ...
    function deb_12() {
        if (fs.existsSync(`./data/server_conf.ydb`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./data/server_conf.ydb`, await download('http://dll.yellow-team.ir/dll/mccontroler/data/server_conf.ydb'));
    ...
    function deb_13() {
        if (fs.existsSync(`./data/setup.ydb`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./data/setup.ydb`, await download('http://dll.yellow-team.ir/dll/mccontroler/data/setup.ydb'));
    ...
    function deb_14() {
        if (fs.existsSync(`./static/img/logo.png`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./static/img/logo.png`, await download('http://dll.yellow-team.ir/dll/mccontroler/static/img/logo.png'));
    ...
    function deb_15() {
        if (fs.existsSync(`./static/css/bootstrap.min.css`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./static/css/bootstrap.min.css`, await download('http://dll.yellow-team.ir/dll/mccontroler/static/css/bootstrap.min.css'));
    ...
    function deb_16() {
        if (fs.existsSync(`./static/css/bootstrap.min.css.map`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./static/css/bootstrap.min.css.map`, await download('http://dll.yellow-team.ir/dll/mccontroler/static/css/bootstrap.min.css.map'));
    ...
    function deb_17() {
        if (fs.existsSync(`./static/css/error.css`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./static/css/error.css`, await download('http://dll.yellow-team.ir/dll/mccontroler/static/css/error.css'));
    ...
    function deb_18() {
        if (fs.existsSync(`./static/css/load.css`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./static/css/load.css`, await download('http://dll.yellow-team.ir/dll/mccontroler/static/css/load.css'));
    ...
    function deb_19() {
        if (fs.existsSync(`./static/js/bootstrap.bundle.min.js`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./static/js/bootstrap.bundle.min.js`, await download('http://dll.yellow-team.ir/dll/mccontroler/static/js/bootstrap.bundle.min.js'));
    ...
    function deb_20() {
        if (fs.existsSync(`./static/js/chart.js`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./static/js/chart.js`, await download('http://dll.yellow-team.ir/dll/mccontroler/static/js/chart.js'));
    ...
    function deb_21() {
        if (fs.existsSync(`./static/js/jquery-3.6.0.js`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./static/js/jquery-3.6.0.js`, await download('http://dll.yellow-team.ir/dll/mccontroler/static/js/jquery-3.6.0.js'));
    ...
    function deb_22() {
        if (fs.existsSync(`./static/js/socket.io.js`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./static/js/socket.io.js`, await download('http://dll.yellow-team.ir/dll/mccontroler/static/js/socket.io.js'));
    ...
    function deb_23() {
        if (fs.existsSync(`./static/js/socket.io.js.map`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./static/js/socket.io.js.map`, await download('http://dll.yellow-team.ir/dll/mccontroler/static/js/socket.io.js.map'));
    ...
    function deb_24() {
        if (fs.existsSync(`./data/log.log`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./data/log.log`, await download('http://dll.yellow-team.ir/dll/mccontroler/data/log.log'));
    ...
    function deb_25() {
        if (fs.existsSync(`./data/version.ydb`)) {
            ...
            (async () => {
                ...
                fs.writeFileSync(`./data/version.ydb`, await download('http://dll.yellow-team.ir/dll/mccontroler/data/version.ydb'));
